...
!      allocatable sbuf1(:)
!      character(6) TAPES(40)
!      data TAPES /'TAPE41','TAPE42','TAPE43','TAPE44','TAPE45', &
!                  'TAPE46','TAPE47','TAPE48','TAPE49','TAPE50', &
!                  'TAPE51','TAPE52','TAPE53','TAPE54','TAPE55', &
!                  'TAPE56','TAPE57','TAPE58','TAPE59','TAPE60', &
!                  'TAPE61','TAPE62','TAPE63','TAPE64','TAPE65', &
!                  'TAPE66','TAPE67','TAPE68','TAPE69','TAPE70', &
!                  'TAPE71','TAPE72','TAPE73','TAPE74','TAPE75', &
!                  'TAPE76','TAPE77','TAPE78','TAPE79','TAPE80'/
!  ...test......test......test......test......test......test......test...
...
!  ...test......test......test......test......test......test......test...
!************************************************************************
!      if(commnd.eq.'WRITE')then
!      if(irec.gt.40)then
!        write(*,*)'ZDIRIO: IREC TOO BIG =',irec
!        stop
!      endif
!      write(*,*)'DUMPING...irec=',irec
!----------------------------
!        open(40,file=TAPES(irec))
!        write(40,*)(Sbuf(ii),ii=1,len)
!        close(40)
!      elseif(commnd.eq.'READ')then
!----------------------------
!        allocate( sbuf1(len), STAT = i1)
!        if(i1.ne.0)then
!          write(*,*)'ZDIRIO: did not allocate sbuf1'
!          stop
!        endif
!        open(40,file=TAPES(irec))
!        read(40,*)(Sbuf1(ii),ii=1,len)
!        close(40)
!    ...compare sbuf,sbuf1
!        do ii=1,len
!           if(abs(sbuf(ii)-sbuf1(ii)).gt.1.d-10)then
!             write(*,*)'ZDIRIO: sbuf1-sbuf=',abs(sbuf(ii)-sbuf1(ii))
!             write(*,*)'IREC,II=',irec,ii
!             stop
!           endif
!           enddo
!        deallocate(sbuf1,STAT = i1)
!      endif
!************************************************************************
!  ...test......test......test......test......test......test......test...
!  ...test......test......test......test......test......test......test...
