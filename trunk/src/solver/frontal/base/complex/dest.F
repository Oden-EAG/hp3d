...
c             in the front will transfer to, as each exiting dof is
c             eliminated
c*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*
...
c
      integer    :: Nd, Nee
      complex(8) :: Aldest(*), Amdest(*), Andest(*)
c
...
c
      ...
      iprint = 0
      if (iprint.eq.1) then
        write(NFSOUT,*) 'DEST: Nd, Aldest = ',Nd
        write(NFSOUT,7001) (Aldest(iii),iii=1,Nd)
