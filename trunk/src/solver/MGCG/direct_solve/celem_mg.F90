...
!                        for a coupled problem for the multigrid DPG
!                        solver
!
...
!
   implicit none
!
   integer,                     intent(in)  :: Ielc,Iel,Mdle,Idec
...
!..perform static condensation of middle node dof
   if (Iel .ge. 0) then
!  ...mg macro grid
      call stc_fwd_wrapper_mg(Ielc,Iel,Mdle)
   else
!  ...coarse grid
      call stc_fwd_wrapper(Ielc,Mdle)
   endif
!
!***********************************************************************
!
