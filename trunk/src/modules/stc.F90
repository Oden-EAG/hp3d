...
!           ...get index of this component for this node
               ...
               select case(index(k))
                  case(2)
                     ...
                     nn = nn+1
!                 ...copy the dof
                     NODES(nod)%zdofH(ivar,j) = Xb(nn,load)
#if DEBUG_MODE
                     if (iprint.eq.1) then
 ...
 7007                   format('stc_solout: nod,j,ivar,NODES(nod)%zdofH(ivar,j)', &
                               ' = ',i5,i3,i3,x,2e13.5)
                     endif
                  case default
...
!           ...get index of this component for this node
               ...
               select case(index(k))
                  case(4)
                     ...
                     nn = nn+1
!                 ...copy the dof
                     NODES(nod)%zdofE(ivar,j) = Xb(nn,load)
#if DEBUG_MODE
                     if (iprint.eq.1) then
                        write(*,7006) nn,load,Xb(nn,load)
                        write(*,7009) nod,j,ivar,NODES(nod)%zdofE(ivar,j)
 7009                   format('stc_solout: nod,j,ivar,NODES(nod)%zdofE(ivar,j)', &
                               ' = ',i5,i3,i3,x,2e13.5)
                     endif
                  case default
!                 ...No other case should ever occur on middle node
...
!           ...get index of this component for this node
               ...
               select case(index(k))
                  case(6)
                     ...
                     nn = nn+1
!                 ...copy the dof
                     NODES(nod)%zdofV(ivar,j) = Xb(nn,load)
#if DEBUG_MODE
                     if (iprint.eq.1) then
                        write(*,7006) nn,load,Xb(nn,load)
                        write(*,7010) nod,j,ivar,NODES(nod)%zdofV(ivar,j)
 7010                   format('stc_solout: nod,j,ivar,NODES(nod)%zdofV(ivar,j)', &
                               ' = ',i5,i3,i3,x,2e13.5)
                     endif
                  case default
!                 ...No other case should ever occur on middle node
...
!           ...get index of this component for this node
               ...
               select case(index(k))
                  case(8)
                     ...
                     nn = nn+1
!                 ...copy the dof
                     NODES(nod)%zdofQ(ivar,j) = Xb(nn,load)
#if DEBUG_MODE
                     if (iprint.eq.1) then
                        write(*,7006) nn,load,Xb(nn,load)
                        write(*,7011) nod,j,ivar,NODES(nod)%zdofQ(ivar,j)
 7011                   format('stc_solout: nod,j,ivar,NODES(nod)%zdofQ(ivar,j)', &
                               ' = ',i5,i3,i3,x,2e13.5)
                     endif
                  case default
!                 ...No other case should ever occur on middle node
