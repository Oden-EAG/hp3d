...
!         add value to visualization object
          val_array(1:3,n_vert_offset(i)+iv) = val
        enddo
!
      enddo
!$OMP END PARALLEL DO
!
      do i=1,Ic
        call vis_vector_add_value(val_array(1:3,i));
      enddo
