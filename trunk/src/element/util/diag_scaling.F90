...
!      
      ...
      integer                   :: nk, n1, n2
#if C_MODE
      complex*16, intent(inout) :: GP(m*(m+1)/2)  
      complex*16, intent(inout) :: B(m,n)  
      complex*16                :: D(m)
#else
...
!      
      ...
      integer                   :: nk, n1, n2
#if C_MODE
      complex*16, intent(inout) :: GP(m,m)  
      complex*16, intent(inout) :: B(m,n)  
      complex*16                :: D(m)
#else
...
!      
      ...
      integer                   :: i,j,k
#if C_MODE
      complex*16, intent(in)    :: DA(n) 
      complex*16, intent(inout) :: SA(Nz), Rhs(n,Nrhs)  
#else
