...
!         option label // explanation // default value // parameter
   ...
   call get_option_string  &
        ('-file-geometry'  ,'Geometry file'            ,'./geometries/tet_hexa_prism' ,FILE_GEOM)
!
   call get_option_string  &
...
!
   call get_option_int     &
        ('-orient_dec','control flag for changing orientations'    ,0,ORIENT_DEC)
!
   call get_option_int     &
        ('-orient_no','curve, triangle or rectangle number'    ,0,ORIENT_NO)
!
   call get_option_int     &
        ('-orient_or','requested new orientation'    ,0,ORIENT_OR)
!
! =============================
! ========= PARAVIEW ==========
! =============================
