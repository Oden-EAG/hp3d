...
!$OMP THREADPRIVATE (EnrTrace)
      real*8, dimension(3*MAXbrickHH,MAXNRHS_MOD) :: EnrLoad
...
!$OMP THREADPRIVATE (EnrStiffness)
      real*8, dimension(3*MAXbrickHH,3*MAXbrickH+3*MAXbrickV+MAXNRHS_MOD) :: EnrEverything
!$OMP THREADPRIVATE (EnrEverything)
      real*8, dimension(3*MAXbrickH+3*MAXbrickV,3*MAXbrickH+3*MAXbrickV+MAXNRHS_MOD) :: FullDPG
