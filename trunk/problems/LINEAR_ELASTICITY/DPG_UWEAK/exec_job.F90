...
!
   implicit none
!
   integer :: i,ierr,nstop,physNick,flag(5)
...
! 
!     ...single adaptive h-refinement
      if(RANK .eq. ROOT) write(*,200) 'adaptive h-refinement...'
...
!..compute error on last mesh
   ...
   call href_solve(INOREFINEMENT,0,flag,physNick,nstop)
!
  100 format(/,'/////////////////////////////////////////////////////////////', &
             /,'             ',A,I2,/)
  200 format(/,'-------------------------------------------------------------', &
