...
subroutine fine_to_coarse_projection_error_new(nr_mdle_sons,coeff,Nextract,nrdofmQ,nrdofgQ,Mdle,&
    ...
    real(8), dimension(nrdofmQ), intent(in) :: coeff
    integer, dimension(nrdofmQ), intent(in) :: Nextract
    real(8),dimension(MAXNINT3ADD,2,nr_mdle_sons),intent(in) :: weights_fine_store
    real(8),dimension(3,MAXNINT3ADD,nr_mdle_sons),intent(in) :: quad_point_store
    real(8),dimension(MAXbrickQQ,MAXNINT3ADD,nr_mdle_sons), intent(in) :: shap3DQ_fine_store
    real(8),dimension(MAXbrickQQ,MAXNINT3ADD,nr_mdle_sons), intent(in) :: shap3DQ_coarse_store
    integer,dimension(nr_mdle_sons),intent(in) :: nint_pp_store
    real(8),    intent(out) :: proj_error
...
end subroutine fine_to_coarse_projection_error_new

!--------------------------------------new subson projection error computation function-------------------------
...
end subroutine fine_to_subson_projection_error_new