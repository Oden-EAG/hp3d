...
! !  ...initialize the Gram matrix
      Gram=ZERO
!
      ! write(*,*) 'Number of integration points (SUBTESSELLATION), nordp =',nint,nordp
!-----------------------------------------------------------------------------------
...
!           end of integration point loop
      ...
      ! write(*,*) 'ELEMENT INTEGRATION TIME (SUBTESSELLATION)=',clock2-clock1
!
!-----------------------------------------------------------------------------------
...
!
 ...
 !        close(gdump)
 !        bdump1=76
 !        open(unit=bdump1,file='output/b_u_mono', &
 !          form='formatted',access='sequential',status='unknown')
 !        do i=1,enrdof
 ...
 !        close(bdump1)
 !        bdump2=77
 !        open(unit=bdump2,file='output/b_sigma_mono', &
 !          form='formatted',access='sequential',status='unknown')
 !        do i=1,enrdof
 ...
 !        close(bdump2)
 !        bdump3=78
 !        open(unit=bdump3,file='output/b_omega_mono', &
 !          form='formatted',access='sequential',status='unknown')
 !        do i=1,enrdof
 ...
 !        close(bdump5)
 !        bdump6=81
 !        open(unit=bdump6,file='output/f_mono', &
 !          form='formatted',access='sequential',status='unknown')
 !        do i=1,enrdof
