...
!  ...print header
      write(6,*)
      write(6,*) '//                                               //'
      write(6,*) '// ------- PRIMAL DPG FOR HYPERELASTICITY ------ //'
      write(6,*) '//                                               //'
      write(6,*)
   endif
   flush(6)
...
!  (1) - H1 field for displacement (3 components)
...
!
      ...
      write(*,*) '          ---- Solvers ----              '
      ! write(*,*) 'MUMPS (MPI)............................40'
      write(*,*) 'MUMPS-based NonLinear solver-Custom....41'
      write(*,*) 'MUMPS-based NonLinear solver-Preset....49'
