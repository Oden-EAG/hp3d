subroutine generate_visual_poly_elem
...
!
!     miscellanea
  integer :: nint,icase,iattr,l,i,j,ibeg,iflag,iload,icomp,ndom,ivar,nflag,k,nordp
...
! end loop over elements
  ...
  close(dump_shape)
  close(dump_e3d)
end subroutine generate_visual_poly_elem

subroutine generate_visual_poly_face
...
!           -- EXACT SOLUTION --
        call exact(x,fn,0, zvalH,zdvalH,zd2valH, zvalE,zdvalE,zd2valE, &
                          zvalV,zdvalV,zd2valV,zvalU, zvalF, zvalQ,zdvalQ,zd2valQ)
!
!
        ...
        write(dump_exa,9876) jf,npt_total+l,original,x(1:3),zvalU( 1:3),zvalF( 1:3)
        write(dump_num,9876) jf,npt_total+l,original,x(1:3),zsolU( 1:3),zsolF( 1:3)
        write(dump_err,9876) jf,npt_total+l,original,x(1:3),errorU(1:3),errorF(1:3)
...
end subroutine generate_visual_poly_face
