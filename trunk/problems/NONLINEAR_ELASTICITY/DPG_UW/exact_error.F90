...
!$OMP REDUCTION(+:error_subd,rnorm_subd)
   do iel=1,NRELES_SUBD
      call element_error_modif(ELEM_SUBD(iel),iflag,           &
...
!
 ...
 7020 format('exact_error: NRDOF_TOT, L2 ERROR (u,P,F) AND NORM = ',i8,3x,2es12.5)
      write(*,7030) NRDOF_TOT,sqrt(err/rnorm)
 7030 format('exact_error: NRDOF_TOT, RELATIVE L2 ERROR (u,P,F) = ',i8,3x,es12.5)
   endif
!
   90 continue
!
