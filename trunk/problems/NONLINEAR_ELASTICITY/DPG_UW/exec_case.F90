...
!
   ...
   use hyperelasticity, only: test_stiffness_tensor
!
   implicit none
!
...
!  
      case(48)
         ...
         call nl_elast_solve_ref(N_incr,Step_size,Abs_tol,Rel_tol,Maxiter,Nupdate,Lsflag_tmp,Bfgs_tmp,pvflag)
...
!  
      case(49)
         ...
         Lsflag_tmp = .false.
         Bfgs_tmp   = .true.
         call nl_elast_solve_ref(N_incr,Step_size,Abs_tol,Rel_tol,Maxiter,Nupdate,Lsflag_tmp,Bfgs_tmp)
