...
!
   ! superlong = 98765432109876543210987654321098765432_16
   ! write(*,*) 'superlong=',superlong

   if (RANK .eq. ROOT) then
!  ...print header
      write(6,*)
      write(6,*) '//                                               //'
      write(6,*) '// --------- UW DPG FOR HYPERELASTICITY -------- //'
      write(6,*) '//                                               //'
      write(6,*)
   endif
   flush(6)
...
!..initialize physics, geometry, etc.
 ...
 1020 format (A,I3,A)
   ...
   call initialize
   ! call initialize_Ftensor
   call MPI_BARRIER (MPI_COMM_WORLD, ierr); end_time   = MPI_Wtime()
   if (RANK .eq. ROOT) write(6,1015) end_time-start_time
 1015 format(' initialize : ',f12.5,' seconds',/)
!
!..set interface variables
!  (1) - H1 trace for displacement (3 components)
!  (2) - Hdiv trace for traction (3 components)
!  (3) - L2 field for displacement (3 components)
!  (4) - L2 field for PK1 stress (9 components)
!  (5) - L2 field for deformation grad (9 components)
   PHYSAi(1:5) = (/.true.,.true.,.false.,.false.,.false./)
!..Statis condensation flags
   ISTC_FLAG = .true.
   STORE_STC = .true.
   HERM_STC  = .false.
!
...
!
      ...
      ! write(*,*) 'Multiple adaptive h-refs + solve.......27'
      write(*,*) '                                         '
      ! write(*,*) '        ---- MPI Routines ----           '
      ...
      write(*,*) '          ---- Solvers ----              '
      ! write(*,*) 'MUMPS (MPI)............................40'
      write(*,*) 'NL solver-Custom-fixed mesh............46'
      write(*,*) 'NL solver-Preset-fixed mesh............47'
      write(*,*) 'NL solver-Custom-refine mesh...........48'
      write(*,*) 'NL solver-Preset-refine mesh...........49'
      ...
      write(*,*) 'Compute DPG residual...................51'
      ! write(*,*) '                                         '
      ! write(*,*) '          ---- TESTING ----              '
      ! write(*,*) 'Test elasticity tensor norm............80'
