...
!                  option label     // explanation               // default value             // parameter
   call get_option_string('-file-control'    ,'Control file'              ,'./control/control' ,FILE_CONTROL)
   call get_option_string('-file-geometry'   ,'Geometry file'             ,'./geometries/hexa' ,FILE_GEOM   )
...
!                        option label     // explanation                                   // default       // parameter
   ...
   call get_option_int(   '-bc'              ,'Bound. Cond.: 1)Dirichlet, 2)Neumann, 3)Impedance'  ,BC_IMPEDANCE    ,IBC_PROB   )
...
!
!..acoustics specific
   call get_option_real( '-rnum'          , 'RNUM'          , 10.d0  , RNUM       )
