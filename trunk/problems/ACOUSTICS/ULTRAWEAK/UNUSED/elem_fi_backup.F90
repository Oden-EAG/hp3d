...
!----------------------------------------------------------------------
!    
   subroutine elem_DPG_UWEAK_ACOUSTICS_fi(Mdle,nrTest,nrTrial,     &
...
!                       ...loops over components of gradient of functions J and I
                           ...
                           enddo                  
                           Gram(m1,m2) = Gram(m1,m2)       &
                                  + ALPHA*shapH1(i1,1)*shapH1(j1,1)*AUXHH_B0(k2,k3)
                        endif
!                    ...i1 loop ends    
                     enddo
!                 ...i2 loop ends
...
! ! 
!    deallocate(STIFQ3H_A,STIFQH_A,STIFQ3H_B,STIFQH_B)
!    deallocate(STIFQV_A,STIFQ3V_A,STIFQV_B,STIFQ3V_B)
...
!..find ndof associated with the mdle node of the element
   ...
   ! write(*,*) 'HH_index = ', HH_index(1:nrdofHH-ndofHHmdl)
