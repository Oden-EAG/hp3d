! -----------------------------------------------------------------------
!
!    routine name       - coarse_solve_mumpsMG
!
! -----------------------------------------------------------------------
!
...
! ----------------------------------------------------------------------
!
   subroutine coarse_solve_mumpsMG(mtype)
!      
...
!  ...get information from celem
      call celemMG(mdle,1,nrdofs,nrdofm,nrdofc,nodm,ndofmH, &
...
!$omp do reduction(+:Rhs)
   do iel=1,NRELES_COARSE
      ...
      call celemMG(MDLE_MACRO(iel),2,nrdofs,nrdofm,nrdofc,nodm,ndofmH, &
...
!     ...global dof is:
      ...
      enddo
!
      call store_elem_solMG(iel, ZSOL_LOCc, n1)
!
...
! 
!
   end subroutine coarse_solve_mumpsMG
