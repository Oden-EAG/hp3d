...
subroutine initialize
  ...
  integer, parameter :: MAXNP_PROB   = 5500  ! points
  integer, parameter :: MAXNC_PROB   = 35000  ! curves
  integer, parameter :: MAXTR_PROB   = 55000  ! triangles
  integer, parameter :: MAXRE_PROB   = 100  ! rectangles
  integer, parameter :: MAXBT_PROB   = 1    ! prisms
  integer, parameter :: MAXHE_PROB   = 100  ! hexas
  integer, parameter :: MAXTE_PROB   = 25000  ! tetras
