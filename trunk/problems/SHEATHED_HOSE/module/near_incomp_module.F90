...
!$OMP THREADPRIVATE (EnrTraceStress)
      real*8, dimension(3*MAXbrickHH+MAXbrickQQ,NRRHS_MOD) :: EnrLoad
...
!$OMP THREADPRIVATE (EnrStiffness)
      real*8, dimension(3*MAXbrickHH+MAXbrickQQ,3*MAXbrickH+3*MAXbrickV+MAXbrickQ+NRRHS_MOD) :: EnrEverything
