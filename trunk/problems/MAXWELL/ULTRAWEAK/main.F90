...
!
!     purpose:          - main driver for MPI Program
!                         Maxwell Ultraweak implementation
!
!----------------------------------------------------------------------
!
program main
...
!  ...print header
      write(6,*) 
      write(6,*) '//                                     //'
      write(6,*) '// --   MPI Maxwell Ultraweak DPG   -- //'
      write(6,*) '//                                     //'
      write(6,*)
   endif
   flush(6)
...
!  (1) - Hcurl trace (1 scalar-valued component)
!  (3) - L2 field (6 scalar-valued components)
