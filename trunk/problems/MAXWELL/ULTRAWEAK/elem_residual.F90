...
!    complex*16 :: zsolH(MAXEQNH),zdsolH(MAXEQNH,3),zsolV(MAXEQNV,3),   &
...
!    complex*16, allocatable :: AUXHH_A(:,:,:), AUXHH_A0(:)
!    complex*16, allocatable :: AUXVH_A(:,:),   AUXVH_A0(:,:)
!    complex*16, allocatable :: AUXVV_A(:,:,:), AUXVV_A0(:,:,:)

!    complex*16, allocatable :: AUXHH_B(:,:,:,:), AUXHH_B0(:,:)
!    complex*16, allocatable :: AUXVH_B(:,:,:)  , AUXVH_B0(:,:,:)
!    complex*16, allocatable :: AUXVV_B(:,:,:,:), AUXVV_B0(:,:,:,:)

!    complex*16, allocatable :: LOADH_A(:)
!    complex*16, allocatable :: LOADH_B(:,:)
!    complex*16, allocatable :: LOADV_A(:,:)
!    complex*16, allocatable :: LOADV_B(:,:,:)
! !
...
!    complex*16, allocatable :: BloadHV(:), Gram(:,:)
! !
...
!             call shape3Q(etype,xip,norder,nrdofQ,shapQ)
! !        ...Geometry map
...
! ! 
!    ! deallocate(LOADH_A,LOADH_B,LOADV_A,LOADV_B)
!    !
! !
!    INTEGRATION = nord_add_temp
...
!                      + (ZIMG*OMEGA*(JJStretch(1,1)*zu(1)*v(1)+       &       
!                                     JJStretch(2,2)*zu(2)*v(2)+       &
!                                     JJStretch(3,3)*zu(3)*v(3))       &
!                      -  zp*div_v                                     &
