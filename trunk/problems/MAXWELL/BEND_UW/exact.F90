...
!  ...space for temporary solutions
      VTYPE   :: E, dE(3), d2E(3,3)
      VTYPE   :: zEtmp(3),zDEtmp(3,3)
      VTYPE   :: zKE(3),zDKE(3,3)
      integer :: icomp, idx
!
!------------------------------------------------------------------------------
!
...
! !
!  ...2nd H(curl) ATTRIBUTE H = [curl E - iK*E ] / (-i omega mu)
...
!
!  ...get gradient of K.E
      zEtmp = ValE(1:3,idx) ; zDEtmp = DvalE(1:3,idx,1:3)
      call get_gradKE(Mdle,Xp,zEtmp,zDEtmp,zDKE)
