...
!     ...SHORT FORM
         E(1:3)= valE(1:3,1)
         H(1:3)= valE(1:3,2)
         CE(1) = dvalE(3,1,2) - dvalE(2,1,3)
         CE(2) = dvalE(1,1,3) - dvalE(3,1,1)
         CE(3) = dvalE(2,1,1) - dvalE(1,1,2)
         CH(1) = dvalE(3,2,2) - dvalE(2,2,3)
         CH(2) = dvalE(1,2,3) - dvalE(3,2,1)
         CH(3) = dvalE(2,2,1) - dvalE(1,2,2)
         !  Get the image of A on exact E and H, including PML transformations
         call get_A(Mdle,Xp,E,H,CE,CH,ZJ,ZL)
